<%@ Page Title="内容类型列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListContentType.aspx.cs" Inherits="LotterySln.Web.Admin.ListContentType" %>
...
<div class="clr"></div>
<div id="dlgAdd" style="width:500px; height:200px;" href="/Templates/HtmlPage/AddContentType.htm">

</div>

<script type="text/javascript">
    $(function () {
        treeFun.url = "/ScriptServices/AdminService.asmx/GetContentTypeJson";
        treeFun.init('treeCt');
    })
