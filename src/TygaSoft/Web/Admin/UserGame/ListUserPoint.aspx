<%@ Page Title="用户棋子数" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListUserPoint.aspx.cs" Inherits="LotterySln.Web.Admin.UserGame.ListUserPoint" %>
...
<div id="toolbar">
  <ul>
      <li class="fl">用户：<input type="text" runat="server" id="txtName" maxlength="256" class="txt" /></li>
      <li class="fl ml10">
...
<asp:Repeater ID="rpData" runat="server">
    <HeaderTemplate>
        <table id="bindT" class="easyui-datagrid" title="用户棋子数列表" data-options="rownumbers:true,toolbar:'#toolbar',onClickCell:onClickCell" style="height:auto;">
        <thead>
            <tr>
                <th data-options="field:'f0',checkbox:true"></th>
                <th data-options="field:'f2',sortable:true">用户</th>
                <th data-options="field:'f3',sortable:true,editor:'numberbox'">棋子数</th>
                <th data-options="field:'f7',sortable:true">最近领取时间</th>
            </tr>
        </thead>
        <tbody>
    </HeaderTemplate>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnNew").click(function () {
            $("#hIsUpdate").val("1");
            window.location = "AddUserPoint.aspx";
        })
        ...
        $("#abtnEdit").click(function () {
            ...
            if (cblLen == 1) {
                window.location = "AddUserPoint.aspx?nId=" + cbl[0].f0 + "";
            }
            else {
