<%@ Page Title="添加角色" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddRole.aspx.cs" Inherits="LotterySln.Web.Admin.Members.AddRole" %>
