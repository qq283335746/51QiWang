...
namespace LotterySln.BLL
{
    ...
    {
        private static readonly IUserTicket dal = DALFactory.DataAccess.CreateUserTicket();
        ...
        {
            return dal.GetList(pageIndex, pageSize, sqlWhere, cmdParams);
        }
        ...
        {
            return dal.UpdateStatusBatch(list);
        }
