<%@ Page Title="角色用户分配关系" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddRoleUser.aspx.cs" Inherits="LotterySln.Web.Admin.Members.AddRoleUser" %>
