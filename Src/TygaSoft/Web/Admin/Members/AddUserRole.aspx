<%@ Page Title="用户角色分配" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddUserRole.aspx.cs" Inherits="LotterySln.Web.Admin.Members.AddUserRole" %>
