<%@ Page Title="奖品列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListPrizeTicket.aspx.cs" Inherits="LotterySln.Web.Admin.PrizeTicket.ListPrizeTicket" %>
...
<div id="toolbar">
  <ul>
      <li class="fl">奖品名称：<input type="text" runat="server" id="txtName" maxlength="256" class="txt" /></li>
      <li class="fl ml10">
          所属分类：<input id="txtCategory" runat="server" class="easyui-combotree" style="width:150px;" />
      </li>
      <li class="fl ml10">
...
<asp:Repeater ID="rpData" runat="server">
    <HeaderTemplate>
        <table id="bindT" class="easyui-datagrid" title="奖品列表" data-options="rownumbers:true,toolbar:'#toolbar'" style="height:auto;">
        <thead>
            <tr>
                <th data-options="field:'f0',checkbox:true"></th>
                <th data-options="field:'f2',sortable:true">奖品名称</th>
                <th data-options="field:'f3',sortable:true">棋子数</th>
                <th data-options="field:'f4',sortable:true">图片</th>
                <th data-options="field:'f5',sortable:true">奖品编号</th>
                <th data-options="field:'f6',sortable:true">奖品库存</th>
                <th data-options="field:'f7',sortable:true">最近更新时间</th>
            </tr>
        </thead>
        <tbody>
    </HeaderTemplate>
    <ItemTemplate>
            <tr>
                ...
                <td><%#Eval("PointNum")%></td>
                <td><img src='<%#Eval("ImageUrl")%>' alt="" width="70" height="60" /> </td>
                <td><%#Eval("PNum")%></td>
                <td><%#Eval("StockNum")%></td>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnNew").click(function () {
            $("#hIsUpdate").val("1");
            window.location = "AddPrizeTicket.aspx";
        })
        ...
        $("#abtnEdit").click(function () {
            ...
            if (cblLen == 1) {
                window.location = "AddPrizeTicket.aspx?nId=" + cbl[0].f0 + "";
            }
            else {
