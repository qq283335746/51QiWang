<%@ Page Title="分类列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListCategory.aspx.cs" Inherits="LotterySln.Web.Admin.ListCategory" %>
...
<div class="clr"></div>
<div class="easyui-panel" title="站点分类" style="padding:5px;">
...
<div class="clr"></div>
<div id="dlgAdd" style="width:500px; height:200px;" href="/Templates/HtmlPage/AddCategory.htm">

</div>

<script type="text/javascript">
    $(function () {
        treeFun.url = "/ScriptServices/AdminService.asmx/GetCategoryJson";
        treeFun.init('treeCt');
    })

    function OnAddDlgLoad() {
        treeFun.url = "/ScriptServices/AdminService.asmx/InsertCategory";
        var t = $("#treeCt");
    ...
    function onEditDlgLoad() {
        treeFun.url = "/ScriptServices/AdminService.asmx/UpdateCategory";
        var t = $("#treeCt");
        var node = t.tree('getSelected');
        if (node) {
