<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="LotterySln.Web.Register" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#txtUserName").blur(function () {
                ...
                $.post(url, { userName: $(this).val() }, function (msg) {
                    if (msg == "1") {
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="pagemain">
          ...
          <div class="easyui-panel" title="注册会员" style="width:400px;">
            <div class="row mt10 tc">
               <span id="msg" class="cr"></span>
               <div class="clr"></div>
             </div>
             <div class="row mt10">
               <span class="fl rl">用户名：</span>
               <div class="fl">
                   <input type="text" runat="server" id="txtUserName" clientidmode="Static" name="txtUserName" class="easyui-validatebox txt" data-options="required:true,missingMessage:'必填项'" />
               </div>
               <div class="clr"></div>
             </div>
             <div class="row mt10">
               <span class="fl rl">设置密码：</span>
               <div class="fl"><input type="password" runat="server" id="txtPsw" clientidmode="Static" name="txtPsw" class="easyui-validatebox  txt" data-options="required:true,missingMessage:'必填项',validType:'psw'" /></div>
               <div class="clr"></div>
             </div>
             <div class="row mt10">
               <span class="fl rl">确认密码：</span>
               <div class="fl"><input type="password" runat="server" id="txtCfmPsw" name="txtCfmPsw" class="easyui-validatebox  txt" data-options="required:true,missingMessage:'必填项'" validType="cfmPsw['#txtPsw']" /></div>
               <div class="clr"></div>
             </div>
             <div class="row mt10">
               <span class="fl rl">电子邮箱：</span>
               <div class="fl"><input type="text" runat="server" id="txtEmail" name="txtEmail" class="easyui-validatebox  txt" data-options="required:true,validType:'email',missingMessage:'必填项',invalidMessage:'请输入正确的电子邮箱格式'" /></div>
               <div class="clr"></div>
             </div>
             <div class="row mt10">
     ...
     <asp:LinkButton runat="server" ID="lbtnPostBack" OnCommand="btn_Command" CommandName="lbtnsave" ClientIDMode="Static" />
